...
#define CONFIG_EXAMPLE_COAP_PSK_KEY "123456"
...
extern float lux_als;

char INITIAL_DATA[128];
...
hnd_espressif_get(coap_resource_t *resource,
                  ...
                  coap_pdu_t *response)
{
    ESP_LOGI(TAG, "Current lux_als: %.4f", lux_als);
    snprintf(INITIAL_DATA, sizeof(INITIAL_DATA),
