...
static esp_err_t veml7700_optimize_configuration(veml7700_handle_t dev, float *lux);
static uint32_t veml7700_get_current_maximum_lux();
static uint32_t veml7700_get_lower_maximum_lux(veml7700_handle_t dev, float* lux);
...
esp_err_t veml7700_read_als_lux(veml7700_handle_t dev, float* lux)
{
...
esp_err_t veml7700_read_als_lux_auto(veml7700_handle_t dev, float* lux)
{
...
esp_err_t veml7700_read_white_lux(veml7700_handle_t dev, float* lux)
{
	esp_err_t i2c_result;
	uint16_t reg_data;
...
esp_err_t veml7700_read_white_lux_auto(veml7700_handle_t dev, float* lux)
{
